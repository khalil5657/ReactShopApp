...
function ShowThem(props){
    ...
    return <>
            <div className={styles.nav}>
                ...
                <div className={styles.test} style={{border:"2px solid black"}} ><Link to="" state={{number: fullNum, items:allItems}}><svg  stroke="currentColor" fill="currentColor"
                ...
                <div className={styles.number}>{fullNum > 99?"99+":fullNum}</div>
            </div>
        </div>
    {result}
